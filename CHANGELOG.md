...
- Updated `homepage` in `package.json` to `https://git-spark.makeboldspark.com` (was GitHub Pages URL)
...
[1.3.2]: https://github.com/MarkHazleton/git-spark/compare/v1.3.1...v1.3.2
