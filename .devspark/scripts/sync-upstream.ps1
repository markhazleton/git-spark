...
<#
.SYNOPSIS
    Sync DevSpark Spark with upstream github.com/github/devspark repository

.DESCRIPTION
    This script helps maintain the DevSpark Spark fork by:
...
| **PR Number** | $(if ($prNumber) { "#$prNumber ([View](https://github.com/github/devspark/pull/$prNumber))" } else { "N/A" }) |
...
**Script Version**: 1.0  
**Repository**: [github/devspark](https://github.com/github/devspark)
...
# Main execution
Write-Header "DevSpark Spark - Upstream Sync Tool"
...
if ($remotes -notcontains 'upstream') {
    ...
    Write-Info "Run: git remote add upstream https://github.com/github/devspark.git"
    exit 1
}
